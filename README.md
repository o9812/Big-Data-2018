...
1. The following table containing special characters and punctuations
```
+---------+-------+
|   cities|friends|
+---------+-------+
...
+---------+-------+
```
1. To clean all latin words through out the table, we done need to put any argument.
...
+--------+-------+
```
1. To clean punctuations for certain column: 
